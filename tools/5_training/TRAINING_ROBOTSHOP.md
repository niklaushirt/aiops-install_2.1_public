# AIOPS AI Manager - LOG ANOMALY TRAINING - ROBOTSHOP
...
# Incident
oc cp ./tools/5_training/3_incidents/trainingdata/test-incidents_robotshop.json $(oc get po |grep model-train-console|awk '{print $1}'):/home/zeno/data/trainingdata/incident/test-incidents_robotshop.json

# Event
oc cp ./tools/5_training/1_events/trainingdata/raw/alerts-noi-robotshop.json $(oc get po |grep model-train-console|awk '{print $1}'):/home/zeno/data/trainingdata/event/$appgroupid/$appid/$version/raw/noi-alerts.json
...
# Logs
oc cp ./tools/5_training/2_logs/trainingdata/raw/log-robotshop.json.gz $(oc get po |grep model-train-console|awk '{print $1}'):/home/zeno/data/trainingdata/log/$appgroupid/$appid/$version/
...
bash index_incidents.sh s3://similar-incident-service/test-incidents_robotshop.json $appgroupid $appid
